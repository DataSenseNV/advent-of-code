...
if __name__ == "__main__":
    ...
    # Loop through mask and check if symbol is adjecent
    sum_of_numbers = 0
    skip_cols = 0
        ...
        for j, element in enumerate(row):
            if element > 0:  # if digit
                ...
                for c in adj_coord:
                    ...
                    if engine_mask_digits_symbols[c[0], c[1]] == -1:
                        near_symbol = True
                if near_symbol:
                ...
                print("Near symbol: {}".format(near_symbol))
